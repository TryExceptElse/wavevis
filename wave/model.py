...
uniform float u_lambda = 4.0;
uniform float u_contrast = 0.25;

uniform float u_phase[N_SOURCES];
uniform float u_amp[N_SOURCES];
uniform float u_dir[N_SOURCES];
...
class Model:
    def __init__(self):
        ...
        self.program['a_position'] = [(-1, -1), (-1, +1),
                                      (+1, -1), (+1, +1)]
        self.contrast = 0.5  # use setter to change uniform
        self.wavelength = 4  # use setter to change uniform
